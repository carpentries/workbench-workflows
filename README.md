...
This workflow takes the updated lockfile produced in "02 Maintain: Check for Updated Packages" and uses it to produce a Docker image cache of the used packages.
This cache can then be reused repeatedly by the "01 Maintain: Build and Deploy Site" workflow, improving build times and allowing consistent package versioning.
...
> 
> If you are developing a lesson in your own repository, caches are saved in your user or organisation GitHub Packages.
> You can see available caches by going to your user account or organisation account, and clicking Packages in the tab list at the top of the page.
